...
public class NOPCommLoginTestNG {
	...
	public void verifyLogin() throws Exception {
		...
		Thread.sleep(5000);
		System.out.println(
				"Attribute value of checkbox: " + driver.findElement(By.name("RememberMe")).getAttribute("type"));
		...
		// tagname or //tagname[@att='value'] or //tagname[@att="value"] or
		// //*[@att='value']
...
//		System.out.println("After login verify Dashboard text : " + all_H1Tags.get(1).getText());
	...
	public void launchApp(String br) throws Exception {
		...
		System.out.println("Executuion on browser: " + br);
		// cross browser testing ----- chrome/edge/firefox/safari etc...

		String browser = br; // fetch from configfile/excelfile/etc..
		...
		if (browser.equalsIgnoreCase("chrome")) {
			...
			System.out.println("Execution of test case on Firefox");
